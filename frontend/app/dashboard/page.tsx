...
export default function DashboardPage() {
  ...
  // Set userType based on user role from the context
  useEffect(() => {
    if (role) {
      setUserType(role as "teacher" | "student");
    }
  }, [role]);

  // Set user name from user data
  useEffect(() => {
    if (user) {
      setUserName(
    ...
    userType === "teacher"
      ? [
          ...
          },
          {
            icon: Brain,
            title: "AI Assistance",
            description: "Generate lesson plans and content",
      ...
      : [
          ...
          },
          {
            ...
            description: "Get help with questions and concepts",
            href: "/dashboard/ai-agents",
          },
          {
            icon: BookOpenCheck,
            title: "Upcoming Exams",
            description: "View exam schedule and prepare",
      ...
      >
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            ...
            {userType === "teacher" ? "classroom" : "studies"} today.
          </p>
        </div>
        <Button
          variant="outline"
        ...
        <TabsContent value="overview" className="space-y-6">
          ...
          <section>
            <h2 className="text-xl font-semibold mb-4">
              {userType === "teacher" ? "Classroom Stats" : "Learning Stats"}
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <motion.div
                initial="hidden"
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <p className="text-sm font-medium">
                          {userType === "teacher"
                            ? index === 0
                              ? "Generated a new lesson plan"
                              : index === 1
                              ? "Updated whiteboard session"
                              : "Uploaded 3 new resources"
                            : index === 0
                            ? "Completed AI study session"
                            : index === 1
                            ? "Participated in whiteboard discussion"
        ...
        <TabsContent value="schedule">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {userType === "teacher"
                  ? "Your teaching schedule for the day"
                  : "Your class schedule for the day"}
              </CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  <div key={index} className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-sm text-muted-foreground">
                        {userType === "teacher" ? "Room 101" : "Room 101"} •{" "}
                        {event.time}
                      </p>
                    </div>
                  </div>
        ...
        <TabsContent value="activities">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                A detailed log of your recent activities on the platform
              </CardDescription>
            </CardHeader>
            <CardContent>
                    ...
                    activities: [
                      {
                        ...
                        title:
                          userType === "teacher"
                            ? "Hosted whiteboard session"
                            : "Joined whiteboard session",
                        time: "May 3, 10:30 AM",
                      },
                      {
                        icon: BarChart3,
                  ...
                  <div key={dayIndex} className="space-y-3">
                    ...
                    <div className="space-y-3">
                      {day.activities.map((activity, actIndex) => (
                        <div
                          key={actIndex}
                          className="flex items-start gap-4 bg-accent/50 rounded-lg p-3"
                        >
                          <div className="rounded-full bg-primary/10 p-2 text-primary">
